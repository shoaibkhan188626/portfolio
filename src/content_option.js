...
const dataportfolio = [
  {
    img: "https://images.unsplash.com/photo-1617450365226-9bf28c04e130?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
    description: "The Mujtaba Helping Foundation",
    link: "https://mhfglobal.com/",
  },
  {
    img: "https://images.unsplash.com/photo-1680084521631-e4e6d77704d8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
    description:
      "I developed and launched the official website for NSAKCET, providing a centralized platform for students and faculty to access important information and stay connected with the college community.",
    link: "https://www.nsakcet.ac.in/",
  },
  {
    img: "https://images.unsplash.com/photo-1661956602944-249bcd04b63f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
    description:
      "AN E-COMMERCE MADE USING REACT FOR FRONT-END AND NODE AND EXPRESS FOR BACK-END",
    link: "#",
  },
  {
  ...
  {
    img: "https://images.unsplash.com/photo-1607398202930-f4c68d729323?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1171&q=80",
    description:
      "I developed a location-based React application that detects the user's location, displays nearby mosques within a 5 km radius, and provides accurate prayer times for enhanced convenience and accessibility.",
...
const socialprofils = {
  ...
  linkedin: "https://www.linkedin.com/in/shoaib-khan-522b48254/",
  instagram: "https://instagram.com/shoebism?igshid=OTk0YzhjMDVlZA==",
};
export {
  meta,
  dataabout,
